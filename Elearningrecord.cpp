...
int main (){
	...
	cout << "Masukan Nama 	 	: ";
	cin >> Ekaoktaviani.nama ;
	cout << "Masukan No KTP 		: ";
	cin >> Ekaoktaviani.ktp;
	cout << "Tujuan			: ";
	...
	tiket.waktuTiba.jam = "07";
	tiket.waktuTiba.menit = "38";
	tiket.waktuTiba.detik = "55";
	tiket.waktuBerangkat.zona = "WIB";
	...
	else if (tiket.kotatujuanKA == "Bandung" && tiket.kotaAsalKA == "Gombong"){
		tiket.harga = "Rp. 98.000";	
	}
	else {
			tiket.harga = "Rp. 0"; 
	}
	...
	cout << "Nama Penumpang  	: " << Ekaoktaviani.nama << endl;
	cout << "No KTP 		 	: " << Ekaoktaviani.ktp << endl << endl;
